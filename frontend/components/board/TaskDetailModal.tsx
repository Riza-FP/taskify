    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="sm:max-w-4xl w-full p-0 overflow-hidden gap-0 bg-white">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 h-[80vh] md:h-[600px]">
                    {/* Main Content Area */}
                        ...
                        <div className="space-y-6 flex-1">
                            ...
                            <div className="space-y-3">
                                ...
                                <Textarea
                                    ...
                                    className="min-h-[150px] resize-none text-slate-700 bg-slate-50/50 border-slate-200 focus:bg-white transition-all shadow-none"
                                />
                            </div>
                        ...
                        <div className="space-y-4">
                            <div className="space-y-1">
                                ...
                                <div className="flex flex-col gap-2 mt-2">
                                    <Button variant="outline" className="justify-start gap-2 bg-white text-slate-700 border-slate-200 hover:bg-slate-100 shadow-sm h-9">
                                        <Tag size={16} />
                                        Labels
                                    </Button>
                                    <Button variant="outline" className="justify-start gap-2 bg-white text-slate-700 border-slate-200 hover:bg-slate-100 shadow-sm h-9">
