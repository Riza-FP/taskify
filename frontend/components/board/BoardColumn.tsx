...
export function BoardColumn({ column, tasks, onTaskClick, createTask }: BoardColumnProps) {
    ...
    if (isDragging) {
        return (
            <div
                ref={setNodeRef}
                style={style}
                className="flex h-[500px] w-80 flex-col rounded-3xl border-2 border-indigo-500/20 bg-indigo-50/50 opacity-40 ring-4 ring-indigo-500/10"
            />
        );
    }
